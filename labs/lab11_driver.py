...
for iM in range(nM):
    ...
    # adaptive routine
    I_new, X = adaptive_quad(a, b, f, tol, M, method)
...
plt.savefig(f'./plots/lab11/{method.__name__}_on_{a}_to_{b}_error.png')
plt.cla()
...
ax.legend()
plt.suptitle(f'{method.__name__}')
plt.savefig(f'./plots/lab11/{method.__name__}_on_{a}_to_{b}_mesh.png')
